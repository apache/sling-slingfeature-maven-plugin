...
public class JSONFeatures {
        ...
        for (final Extension ext : feature.getExtensions()) {
            if (ext.getType() == ExtensionType.TEXT && ext.getText().startsWith(FILE_PREFIX)) {
                ...
                final String baseName =
                        pos == -1 ? file.getName() : file.getName().substring(0, pos);
    ...
    public static void handleDefaultMetadata(
            final Feature feature, final Map<String, Map<String, String>> defaultMetadata) {
