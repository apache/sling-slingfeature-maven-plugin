...
public class EmbedFeaturesMojo extends AbstractIncludingFeatureMojo {
    ...
    private void include(final File directory, final Feature feature) throws MojoExecutionException {
        // write the feature
        final String classifier = feature.getId().getClassifier();
        final File outputFile =
                new File(directory, classifier == null ? "feature.json" : "feature-" + classifier + ".json");
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        final Map<String, Feature> features =
                embed == null ? this.selectAllFeatureFilesAndAggregates() : this.getSelectedFeatures(embed);
        if (features.isEmpty()) {
